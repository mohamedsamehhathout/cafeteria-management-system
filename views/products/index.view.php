...
.prod-thumb { width: 50px; height: 50px; border-radius: 8px; object-fit: cover; border: 1px solid var(--border); background-color: #f4f4f4; }
.prod-cell-name { font-size: 14px; font-weight: 800; color: #2C1A0E; }
.prod-cell-desc { font-size: 13px; color: #888; margin-top: 2px; }
.price-badge { font-weight: 700; font-size: 15px; color: var(--primary); }
...
<div class="main-content">
    ...
    <div class="page-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="topbar-title">🍽️ Products Management</h2>
                ...
                <tbody>
                    <?php foreach ($products as $product): ?>
                        <tr>
                            <td>
                                <div class="prod-cell">
                                    <img src="<?= htmlspecialchars($product['image_path'] ?? '/images/default-product.png', ENT_QUOTES) ?>" alt="Product Photo" class="prod-thumb">
